...
export default function Section4() {
	return (
		<div className='h-[120vh] py-10 bg-white text-black font-geograph uppercase flex flex-col justify-around items-center text-center blur-[0.3px]'>
			<div className='font-black text-6xl'>News and Updates</div>
			<div className='font-extrabold text-2xl w-1/3 cursor-pointer hover:underline hover:text-gray-800'>
				<p>
